...
const Leave = () => {
  ...
  const fetchLeaves = async () => {
    try {
      const response = await axios.get(`${Base_Url}/leaves/`, {  withCredentials: true,});
  ...
  const fetchApprovedLeaves = async () => {
    try {
      const response = await axios.get(`${Base_Url}/leaves/approved`, {  withCredentials: true,});
      const approvedLeaves = response.data.data.leaves;
      console.log(approvedLeaves,"here is")
    ...
    <div className="candidates-top-bar">
      ...
      <div className="leaves-content">
        ...
        <div className="applied-leaves">
          <div className='bg-[#5B21B6] text-white p-2'><h2>Applied Leaves</h2>
